# -*- coding: utf-8 -*-
#
# pytest-warnings-report documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-warnings-report Documentation',
     [author], 1)
]
